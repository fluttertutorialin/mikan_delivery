...
class _BottomBarItemViewState extends State<_BottomBarItemView>
  ...
  Widget _toBarIcon(final Color accentColor, final BarItem barItem) {
    ...
    return barItem.icon == null
        ? ExtendedImage.asset(barItem.iconPath!,
            width: barItem._size, height: barItem._size)
        : Icon(barItem.icon, size: barItem._size);
  }
  ...
  List<Widget> _buildPointWidgets(final ThemeData theme) {
    return List.generate(
      _points!.length,
      (index) => _buildPointWidget(_points![index], theme.secondaryHeaderColor),
    );
  }
    ...
    return Positioned(
        ...
        child: ScaleTransition(
            ...
            scale: Tween<double>(begin: 0.0, end: 1.0).animate(CurvedAnimation(
                parent: _animationController,
                curve: Interval(point.interval[0], point.interval[1],
  ...
  List<_Point> _buildPoints() {
    ...
    final Color color = Theme.of(context).secondaryHeaderColor;
